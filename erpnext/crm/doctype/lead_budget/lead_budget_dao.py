...
def find_range_budget(budget_name: str | None, budget_from: int | None, budget_to: int | None):
	if budget_name and frappe.db.exists("Lead Budget", budget_name):
		return frappe._dict({"name": budget_name})
