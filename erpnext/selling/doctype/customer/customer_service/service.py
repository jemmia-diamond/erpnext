...
class CustomerService:
    ...
    def create_haravan_customer(customer_name):
        ...
        try:
            ...
            response = requests.post("https://apis.haravan.com/com/customers.json", json=payload, headers=headers)
            ...
            if response.status_code == 201:
                ...
                if "đã được sử dụng" in error_msg:
                    ...
                    for variant in variants:
                        ...
                        search_url = f"https://apis.haravan.com/com/customers/search.json?query={encoded_query}"
                        ...
                        if search_resp.status_code == 200:
                            ...
                            if customers:
                                ...
                                CustomerService.update_haravan_ids(customer, haravan_id)
                                return {"status": "success", "message": "Linked existing customer", "haravan_id": haravan_id}
